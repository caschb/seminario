...
\end{equation}
Cuando comparamos dos implementaciones de un programa podemos hacerlo con sus rendimientos o sus tiempos de ejecución. Podemos expresar que un programa $a$ es $n$ veces más rápido que un programa $b$ con las ecuaciones \ref{eq:comparison}.
...
$$t_1 = t_s + t_p = 1$$
Y lo definimos como 1 para facilitar los cálculos.
...
$$t_N = t_s + t_p = 1$$
Y lo definimos como 1 para facilitar los cálculos.
Como una aproximación, los autores dicen entonces que el tiempo de ejecución del mismo programa de forma serial sería:
$$t_1 = t_s + t_p\times N$$
